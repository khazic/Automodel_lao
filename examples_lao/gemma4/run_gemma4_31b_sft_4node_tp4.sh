...
#
#   Node 0 (master): NODE_RANK=0 bash examples_lao/gemma4/run_gemma4_31b_sft_4node_tp4.sh
#   Node 1:          NODE_RANK=1 bash examples_lao/gemma4/run_gemma4_31b_sft_4node_tp4.sh
#   Node 2:          NODE_RANK=2 bash examples_lao/gemma4/run_gemma4_31b_sft_4node_tp4.sh
#   Node 3:          NODE_RANK=3 bash examples_lao/gemma4/run_gemma4_31b_sft_4node_tp4.sh
