...
class HFEagle3TargetModel(Eagle3TargetBackend):
    ...
    def generate_batch(
        ...
        # KV reuse: pull the post-projection K/V the target wrote into its own
        # cache during this forward. aux_hidden_states/target_logits are already
        # set by the CP and non-CP branches above.
        target_kv = None
